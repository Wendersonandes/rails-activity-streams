...
class CommentCreation
  ...
  def call
    Activity.transaction do
      ...
      # 5. Propagates visibility by copying audiences from the parent activity (synchronously)
      CreateActivityAudiencesJob.perform_now(comment_activity.id, @parent_activity.relation_ids)
      ...
      # Copy audiences to the like (synchronously)
      CreateActivityAudiencesJob.perform_now(like_activity.id, @parent_activity.relation_ids)
